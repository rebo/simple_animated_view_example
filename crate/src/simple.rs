...
pub fn view() -> Node<Msg> {
    ...
    //
    let (margin_left, anim_group) = use_spring(20.0, 200.0, "margin-left", "px", 0.1, 0.0);
    let padding_top = anim_group.add_spring(20.0, 200.0, "padding-top", "px", 0.1, 0.0);
    let padding_bottom = anim_group.add_spring(20.0, 200.0, "padding-bottom", "px", 0.1, 0.0);
    let margin_right = anim_group.add_spring(20.0, 200.0, "margin-right", "px", 0.1, 0.0);
